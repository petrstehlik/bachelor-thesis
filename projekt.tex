...
\keywords[cs]{JavaScript, Python, MongoDB, vizualizace, NEMEA}
\keywords[en]{JavaScript, Python, MongoDB, visualization, NEMEA}

%Prohlaseni
\declaration{Prohlašuji, že jsem tuto bakalářskou práci vypracoval samostatně pod vedením pana Ing. Pavla Krobota.
