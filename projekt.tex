...
\projectinfo{
  ...
  %Nazev prace
  title.cs={Vizualizace sí»ových bezpeènostních událostí},  %nazev prace v cestine
  ...
  %Prohlaseni
  declaration={Prohla¹uji, ¾e jsem tuto bakaláøskou práci vypracoval samostatnì pod vedením pana Ing. Pavla Krobota},
