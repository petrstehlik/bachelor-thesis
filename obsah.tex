...
Prvními aspekty při výběru knihovny pro vývoj SPA v uživatelské části byla zejména velikost knihovny, množství dostupných modulů, licence, udržovatelnost a v neposlední řadě schopnosti \note{featury, lepší slovo}. Pro rychlý přehled je vytvořena tabulka, která tyto faktory porovnává.

\note{doplnit tabulkou o JS frameworks + přidat počet pluginů z bower/npm/github}
...
\note{doplnit tabulku rychlosti serverů}
