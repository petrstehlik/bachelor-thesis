...
JavaScript je originálně určen do prostředí webových prohlížečů a jejich jader. Google ale vytvořil V8 JavaScriptové jádro primárně určené pro webový prohlížeč, na kterém je ale postaven i framework NodeJS. V8 umožňuje spouštět kód napsaný v JavaScriptu na straně serveru.
