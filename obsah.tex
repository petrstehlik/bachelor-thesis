...
Prvním krokem při vývoji uživatelské části bylo navržení stránky s výpisem poslední. Ta totiž nevyžadovala téměř žádnou konfiguraci a ověřila koncept a funkcionalitu navržené architektury.
