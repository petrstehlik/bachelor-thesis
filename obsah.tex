...
\end{lstlisting}
\label{code:idea}
\captionof{lstlisting}{Vzorový IDEA záznam z NEMEA systému. Některé části byly vynechány nebo zkráceny a IP adresy změněny na lokální.}
\end{figure}
